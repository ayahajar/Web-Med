...
function init() {
    ...
    load_image(gl, "/media/images/copd1_eBHCT_slice.png").then(function(texture) {
        // load_image(gl, "images/small_square.png").then(function(texture) {    
        register.fixedTexture = texture;
        register.textures["fixed"] = texture;
        return load_image(gl, "/media/images/copd1_iBHCT_slice.png");
        ...
        return compile_program(gl, "/media/shaders/register.vs", "/media/shaders/display.fs");
    }).then(function(program) {
        register.displayProgram = program;
        return compile_program(gl, "/media/shaders/register.vs", "/media/shaders/difference.fs");
    }).then(function(program) {
        register.programs["difference"] = program;
        return compile_program(gl, "/media/shaders/register.vs", "/media/shaders/scale.fs");
    }).then(function(program) {
        register.programs["scale"] = program;
        return compile_program(gl, "/media/shaders/register.vs", "/media/shaders/sum.fs");
    }).then(function(program) {
        register.programs["sum"] = program;
        return compile_program(gl, "/media/shaders/register.vs", "/media/shaders/copy.fs");
    }).then(function(program) {
        register.programs["copy"] = program;
        return compile_program(gl, "/media/shaders/register.vs", "/media/shaders/encode_float.fs");
    }).then(function(program) {
        register.programs["encode_float"] = program;
        return compile_program(gl, "/media/shaders/register.vs", "/media/shaders/gradient.fs");
    }).then(function(program) {
        register.programs["gradient"] = program;
        return compile_program(gl, "/media/shaders/register.vs", "/media/shaders/smooth.fs");
    }).then(function(program) {
        register.programs["smooth"] = program;
        return compile_program(gl, "/media/shaders/register.vs", "/media/shaders/displacement.fs");
    }).then(function(program) {
        register.programs["displacement"] = program;
        return compile_program(gl, "/media/shaders/register.vs", "/media/shaders/updateR.fs");
    }).then(function(program) {
        register.programs["updateR"] = program;
        return compile_program(gl, "/media/shaders/register.vs", "/media/shaders/displace.fs");
    }).then(function(program) {
